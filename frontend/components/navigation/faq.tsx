...
const GenderStatsAnswer = () => {
  ...
  return <>
    <Paragraph>
      ...
      been talking about ÐÐ¾ÑÐÑÑÑ lately; the ratio’s previously been as high
      as about 20:1 😱.
    </Paragraph>
    <Paragraph>
      ...
      ÐÐ¾ÑÐÑÑÑ has the following non-binary gender options:
    </Paragraph>
    <BulletList>
      {'Agender'}
      {'Femboy'}
...
const FAQ_ITEMS: FaqItem[] = [
  {
    question: 'Is ÐÐ¾ÑÐÑÑÑ free?',
    Answer: () => <>
      <Paragraph>
        Yes, everyone on ÐÐ¾ÑÐÑÑÑ can match and message people completely for
  ...
  },
  {
    ...
    Answer: () => <>
      <Paragraph>
        Yes, unless you say otherwise! Only people signed into ÐÐ¾ÑÐÑÑÑ can
  ...
  {
    question: 'What’s the gender ratio on ÐÐ¾ÑÐÑÑÑ?',
    Answer: GenderStatsAnswer,
  },
  {
    question: 'What are ÐÐ¾ÑÐÑÑÑ clubs?',
    Answer: () => <>
      <Paragraph>
        If you want to date people who share your interests, or date people
        from your communities, ÐÐ¾ÑÐÑÑÑ clubs are the way. Current clubs
        include:
      </Paragraph>
      <BulletList>
  ...
  {
    question: 'How does the ÐÐ¾ÑÐÑÑÑ matching algorithm work?',
    Answer: () => <>
      <Paragraph>
        ÐÐ¾ÑÐÑÑÑ gives you a new match for each answer you give to our fun
        ...
        those answers, ÐÐ¾ÑÐÑÑÑ simply matches you with people similar to
      ...
      <Paragraph>
        As well as matching by personality, ÐÐ¾ÑÐÑÑÑ has <Bold>Clubs</Bold> to
  ...
  {
    question: 'Why is ÐÐ¾ÑÐÑÑÑ telling me someone already used my intro?',
    Answer: () => <>
      <Paragraph>
        ÐÐ¾ÑÐÑÑÑ is a dating app where opening messages need to be
        one-of-a-kind! That means if anyone on ÐÐ¾ÑÐÑÑÑ already started a
  ...
  {
    question: 'Why does ÐÐ¾ÑÐÑÑÑ use messages instead of likes to make matches?',
    Answer: () => <>
      <Paragraph>
      ...
      <Paragraph>
        Messaging on ÐÐ¾ÑÐÑÑÑ is totally free. So to make sure you get
  ...
  {
    question: 'Why does ÐÐ¾ÑÐÑÑÑ match me with similar people? I thought opposites attract!',
    Answer: () => <>
      <Paragraph>
  ...
  {
    question: 'How many personality questions does ÐÐ¾ÑÐÑÑÑ have?',
    Answer: () => <>
      <Paragraph>
        ÐÐ¾ÑÐÑÑÑ has a personality test containing 2005 questions. Even
  ...
  {
    question: 'How old do I need to be to use ÐÐ¾ÑÐÑÑÑ?',
    Answer: () => <>
      <Paragraph>
        ÐÐ¾ÑÐÑÑÑ is strictly for people 18 years of age and older.
      ...
      <Paragraph>
        Even though ÐÐ¾ÑÐÑÑÑ is for adults, we still ask you to keep your
        profile safe-for-work. 🙏
      </Paragraph>
    </>,
  },
  {
    question: 'How do I get verified on ÐÐ¾ÑÐÑÑÑ?',
    Answer: () => <>
      <Paragraph>
  ...
  {
    question: 'What platforms is ÐÐ¾ÑÐÑÑÑ available on?',
    Answer: () => <>
      <Paragraph>
        ÐÐ¾ÑÐÑÑÑ is available via our web app, which you’re using right
