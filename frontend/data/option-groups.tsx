...
const lookingForOptionGroup: OptionGroup<OptionGroupButtons> = {
  ...
  description: 'What are you mainly looking for on ÐÐ¾ÑÐÑÑÑ?',
  input: {
    buttons: {
      values: lookingFor,
...
const privacySettingsOptionGroups: OptionGroup<OptionGroupInputs>[] = [
  {
    ...
    description: () => (
      <DefaultText style={descriptionStyle.style}>
        With this option set to ‘Yes’, people who aren’t signed into ÐÐ¾ÑÐÑÑÑ
    ...
    description: () => {
      ...
      return (
        <DefaultText style={descriptionStyle.style}>
          ...
          search, or anywhere else in ÐÐ¾ÑÐÑÑÑ until you message them first.
          {!signedInUser?.hasGold && ' Unlock this feature with Gold.'}
        </DefaultText>
      )
    },
